...
<s:if test="%{#item==0}">
<td class="td"> <button id=" <s:property value='#count' /><s:property value='#column' />" type="button" class="btn btn-danger btn-circle btn-lg" disabled="disabled"></button>  </td> 
</s:if>
<s:else>
<td class="td"> <button id=" <s:property value='#count' /><s:property value='#column' />" type="button" class="btn btn-primary btn-circle btn-lg"></button>  </td> 
</s:else>
...
<s:submit theme="simple" cssClass="btn btn-primary  pull-right" value="Comprar" ></s:submit>
