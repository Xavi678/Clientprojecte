   ...
   <div class="collapse navbar-collapse navbar-ex1-collapse">
     ...
     <s:form id="form" class="navbar-form navbar-left" theme="simple" action="searchby" >
      <div class="form-group">
       ...
       <span class="data"> <s:text name="header.datafi"></s:text> </span> <s:textfield id="data" type="date"  cssClass="form-control" placeholder="%{getText('header.buscadata')}" name="dataFi" theme="simple"></s:textfield>
      </div>
